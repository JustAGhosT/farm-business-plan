...
VALUES (
    ...
    '{"demand": "High", "price_range_per_kg": "50-100 ZAR", "markets": ["Export", "Local retail", "Restaurants"], "season": "Year-round with peak Nov-Apr", "storage": "7-14 days refrigerated"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Specialty Crops',
    '{"spacing": "1m x 1m for intensive leaf production", "propagation": "Seeds or cuttings", "maturity": "6-8 months", "harvest_frequency": "Multiple times per year (6-8 harvests)", "plantDensity": "10,000 plants/ha"}'::jsonb,
    ...
    '{"demand": "Growing", "price_range_per_kg": "40-80 ZAR (dried leaves)", "markets": ["Health food stores", "Export", "Powder production"], "season": "Year-round", "value_added": "Leaf powder, tea, oil"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Specialty Crops',
    '{"spacing": "60-75cm rows, 20-30cm in-row", "propagation": "Direct seeding", "maturity": "90-120 days", "harvest_frequency": "Once per season", "plantDensity": "40,000-60,000 plants/ha"}'::jsonb,
    ...
    '{"demand": "Stable", "price_range_per_ton": "8,000-12,000 ZAR", "markets": ["Oil processors", "Direct sale", "Export"], "season": "Summer crop", "uses": "Oil, birdseed, confectionery"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Field Crops',
    '{"spacing": "Broadcast seeding 20-30 kg/ha", "propagation": "Seed", "maturity": "First cut 90-120 days", "harvest_frequency": "6-8 cuts per year", "plantDensity": "Broadcast"}'::jsonb,
    ...
    '{"demand": "Stable", "price_range_per_bale": "80-120 ZAR", "markets": ["Dairy farms", "Horse owners", "Livestock farmers"], "season": "Year-round production", "quality_factors": "Protein content, leaf-to-stem ratio"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Field Crops',
    '{"spacing": "45-75cm rows, 5-10cm in-row", "propagation": "Direct seeding", "maturity": "100-140 days", "harvest_frequency": "Once per season", "plantDensity": "300,000-500,000 plants/ha"}'::jsonb,
    ...
    '{"demand": "High", "price_range_per_ton": "7,000-10,000 ZAR", "markets": ["Processors", "Export", "Livestock feed"], "season": "Summer crop", "uses": "Oil, protein meal, food"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Field Crops',
    '{"spacing": "60-90cm rows, 10-15cm in-row", "propagation": "Direct seeding", "maturity": "90-120 days", "harvest_frequency": "Once per season", "plantDensity": "150,000-300,000 plants/ha"}'::jsonb,
    ...
    '{"demand": "Stable", "price_range_per_ton": "3,500-5,000 ZAR", "markets": ["Livestock feed", "Breweries", "Food processors"], "season": "Summer crop", "uses": "Animal feed, brewing, food"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Field Crops',
    '{"spacing": "75-90cm rows, 20-25cm in-row", "propagation": "Direct seeding", "maturity": "100-140 days", "harvest_frequency": "Once per season", "plantDensity": "50,000-80,000 plants/ha"}'::jsonb,
    ...
    '{"demand": "Very high", "price_range_per_ton": "3,000-4,500 ZAR", "markets": ["Millers", "Livestock feed", "Industrial"], "season": "Summer crop", "uses": "Human food, animal feed, industrial"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Field Crops',
    '{"spacing": "Broadcast or drilled 15-18cm rows", "propagation": "Seed", "maturity": "120-150 days", "harvest_frequency": "Once per season", "plantDensity": "150-180 kg seed/ha"}'::jsonb,
    ...
    '{"demand": "High", "price_range_per_ton": "4,000-5,500 ZAR", "markets": ["Millers", "Bakers", "Export"], "season": "Winter crop", "quality_factors": "Protein content, gluten strength"}'::jsonb,
    true
);
...
VALUES (
    ...
    '{"demand": "Very high", "price_range_per_ton": "6,000-10,000 ZAR", "markets": ["Retail", "Processors", "Food service"], "season": "Cool season", "quality_factors": "Size, specific gravity, fry color"}'::jsonb,
    true
);
...
VALUES (
    ...
    '{"demand": "High", "price_range_per_ton": "5,000-8,000 ZAR", "markets": ["Retail", "Export", "Food service"], "season": "Warm season", "quality_factors": "Size, color, sweetness, storage"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Root Vegetables',
    '{"spacing": "45-60cm rows, 5-10cm in-row", "propagation": "Direct seeding", "maturity": "60-90 days", "harvest_frequency": "Once per planting", "plantDensity": "300,000-500,000 plants/ha"}'::jsonb,
    ...
    '{"demand": "Moderate to high", "price_range_per_kg": "8-15 ZAR", "markets": ["Retail", "Restaurants", "Processing"], "season": "Cool season", "storage": "3-4 months refrigerated"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Root Vegetables',
    '{"spacing": "30-45cm rows, 2-5cm in-row", "propagation": "Direct seeding", "maturity": "70-100 days", "harvest_frequency": "Once per planting", "plantDensity": "800,000-1,200,000 plants/ha"}'::jsonb,
    ...
    '{"demand": "High", "price_range_per_kg": "6-12 ZAR", "markets": ["Retail", "Processing", "Export"], "season": "Cool season", "quality_factors": "Straightness, color, size uniformity"}'::jsonb,
    true
);
...
VALUES (
    ...
    '{"demand": "Very high", "price_range_per_kg": "5-12 ZAR", "markets": ["Retail", "Export", "Food service"], "season": "Cool season", "storage": "3-8 months depending on variety"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Fruiting Vegetables',
    '{"spacing": "90-120cm rows, 45-60cm in-row", "propagation": "Transplants", "maturity": "70-90 days", "harvest_frequency": "Multiple harvests over 3-4 months", "plantDensity": "10,000-25,000 plants/ha"}'::jsonb,
    ...
    '{"demand": "Very high", "price_range_per_kg": "8-20 ZAR", "markets": ["Retail", "Restaurants", "Processing"], "season": "Warm season", "quality_factors": "Firmness, color, flavor, shelf life"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Fruiting Vegetables',
    '{"spacing": "75-90cm rows, 40-50cm in-row", "propagation": "Transplants", "maturity": "65-90 days", "harvest_frequency": "Multiple harvests", "plantDensity": "20,000-30,000 plants/ha"}'::jsonb,
    ...
    '{"demand": "High", "price_range_per_kg": "12-25 ZAR", "markets": ["Retail", "Restaurants", "Processing"], "season": "Warm season", "quality_factors": "Size, color, firmness, heat level (chili)"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Fruiting Vegetables',
    '{"spacing": "100-150cm rows, 30-45cm in-row", "propagation": "Direct seed or transplants", "maturity": "50-70 days", "harvest_frequency": "Daily to every 2-3 days", "plantDensity": "20,000-40,000 plants/ha"}'::jsonb,
    ...
    '{"demand": "High", "price_range_per_kg": "6-15 ZAR", "markets": ["Retail", "Pickling", "Fresh markets"], "season": "Warm season", "quality_factors": "Straightness, color, crispness"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Leafy Vegetables',
    '{"spacing": "30-40cm rows, 20-30cm in-row", "propagation": "Direct seed or transplants", "maturity": "45-70 days", "harvest_frequency": "Once per planting", "plantDensity": "100,000-150,000 plants/ha"}'::jsonb,
    ...
    '{"demand": "Very high", "price_range_per_head": "8-20 ZAR", "markets": ["Retail", "Restaurants", "Fast food"], "season": "Cool season", "quality_factors": "Crispness, head formation, shelf life"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Leafy Vegetables',
    '{"spacing": "30-40cm rows, 8-15cm in-row", "propagation": "Direct seeding", "maturity": "40-60 days", "harvest_frequency": "Cut and come again or single harvest", "plantDensity": "400,000-800,000 plants/ha"}'::jsonb,
    ...
    '{"demand": "High", "price_range_per_kg": "15-30 ZAR", "markets": ["Retail", "Restaurants", "Processing"], "season": "Cool season", "quality_factors": "Leaf size, color, tenderness"}'::jsonb,
    true
);
...
VALUES (
    ...
    'Leafy Vegetables',
    '{"spacing": "60-75cm rows, 40-50cm in-row", "propagation": "Transplants", "maturity": "70-120 days", "harvest_frequency": "Once per planting", "plantDensity": "30,000-45,000 plants/ha"}'::jsonb,
    ...
    '{"demand": "High", "price_range_per_head": "10-25 ZAR", "markets": ["Retail", "Processing", "Food service"], "season": "Cool season", "storage": "3-4 months refrigerated"}'::jsonb,
    true
);
