...
VALUES (
    ...
    '{"demand": "High", "price_range": "20,000-25,000 ZAR", "price_unit": "ton", "markets": ["Ginneries", "Textile industry", "Export"], "season": "Summer crop", "notes": "Ideal for rotation with maize or sorghum."}'::jsonb,
    true
);
...
VALUES (
    ...
    '{"demand": "Stable", "price_range": "12,000-18,000 ZAR", "price_unit": "ton", "markets": ["Processors for peanut butter", "Snack food industry", "Oil production"], "season": "Summer crop", "notes": "Excellent rotation crop for maize."}'::jsonb,
    true
);
...
VALUES (
    ...
    '{"demand": "Very High", "price_range": "25-40 ZAR", "price_unit": "kg", "markets": ["Export (Europe)", "Local retail", "Food service"], "season": "Varies by cultivar (e.g., Fuerte in winter, Hass in summer)"}'::jsonb,
    true
);
...
VALUES (
    ...
    '{"demand": "High", "price_range": "15-30 ZAR", "price_unit": "kg", "markets": ["Local fresh markets", "Juicing and drying processors", "Export"], "season": "Summer to early autumn"}'::jsonb,
    true
);
...
VALUES (
    ...
    '{"demand": "Very High (Export)", "price_range": "80-120 ZAR", "price_unit": "kg", "markets": ["Export (China, USA, Europe)", "Local processors"], "season": "Harvest from March to July"}'::jsonb,
    true
);
...
VALUES (
    ...
    '{"demand": "High", "price_range": "4,000-7,000 ZAR", "price_unit": "ton", "markets": ["Retail", "Fresh produce markets", "Processing"], "season": "Warm season", "storage": "Can be stored for 3-6 months."}'::jsonb,
    true
);
