    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6 border border-green-200">
          ...
          <div className="text-3xl font-bold text-green-900">{safeSummary.avgRoi?.toFixed(1) || '0.0'}%</div>
      ...
      <Card>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <ul className="space-y-2 text-sm text-blue-800">
            <li>• Average ROI of {safeSummary.avgRoi?.toFixed(1) || '0.0'}% across all investments</li>
            <li>• Total projected investment: {formatCurrency(safeSummary.totalInvestment || 0)}</li>
