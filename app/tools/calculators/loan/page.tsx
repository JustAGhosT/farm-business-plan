              ...
              {results ? (
                <div className="space-y-4">
                  <div className="bg-primary-50 rounded-lg p-4 border-2 border-primary-200">
                    ...
                    <div className="text-xs text-gray-500 mt-2">Fixed monthly installment</div>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    ...
                    <div className="text-xs text-gray-500 mt-2">Over {values.termYears} years</div>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    ...
                    <div className="text-xs text-gray-500 mt-2">Cost of borrowing</div>
                  </div>
