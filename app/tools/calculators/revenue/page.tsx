              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Expected annual increase in production
                  </p>
                </div>

                <div>
                  <label
                    htmlFor="priceInflation"
                    className="block text-sm font-medium text-gray-700 mb-2"
                  >
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Expected annual price growth (inflation)
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
                    <p className="text-sm text-blue-800">
                      ...
                      projections[projections.length - 1].revenue > projections[0].revenue * 1.5
                ...
                <table className="min-w-full border-collapse border border-gray-300">
                  ...
                  <tbody>
                    {projections.map((proj, index) => {
                      const growth =
                        index > 0
                          ? ((proj.revenue - projections[index - 1].revenue) /
                              projections[index - 1].revenue) *
                            100
                          : 0
                      return (
                        <tr key={proj.year} className="hover:bg-gray-50">
                          ...
                          <td className="border border-gray-300 px-4 py-2 text-right">
                            {parseInt(proj.production).toLocaleString()}
                          </td>
                          <td className="border border-gray-300 px-4 py-2 text-right">
                            R {parseFloat(proj.price).toFixed(2)}
                          </td>
