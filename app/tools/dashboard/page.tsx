  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white dark:from-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-10">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-3">Operations Dashboard</h1>
          <p className="text-lg text-gray-600 dark:text-gray-300">Track your farm activities, tasks, and milestones</p>
        </div>

        {/* Stats Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {stats.map((stat, index) => (
            <div key={index} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-7 border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-2 font-medium">{stat.label}</p>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
              ...
              <div className="space-y-4">
                {tasks.map((task) => (
                  <div key={task.id} className="border-2 border-gray-200 dark:border-gray-700 rounded-xl p-5 hover:shadow-lg hover:border-primary-300 dark:hover:border-primary-600 transition-all duration-300 group">
                    <div className="flex items-start justify-between mb-3">
                      <h3 className="font-bold text-gray-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">{task.title}</h3>
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-7 border border-gray-100 dark:border-gray-700">
              ...
              <div className="space-y-3">
                <Link href="/tools/plan-generator" className="block w-full px-5 py-3 bg-primary-50 dark:bg-primary-900/30 text-primary-700 dark:text-primary-400 rounded-lg hover:bg-primary-100 dark:hover:bg-primary-900/50 transition-all duration-300 text-center font-bold shadow-sm hover:shadow-md transform hover:scale-105">
                  📝 Create New Plan
                </Link>
                <Link href="/tools/calculators" className="block w-full px-5 py-3 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/50 transition-all duration-300 text-center font-bold shadow-sm hover:shadow-md transform hover:scale-105">
                  💰 Financial Tools
                </Link>
                <Link href="/tools/templates" className="block w-full px-5 py-3 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-all duration-300 text-center font-bold shadow-sm hover:shadow-md transform hover:scale-105">
                  📚 Browse Templates
                </Link>
              ...
              <div className="space-y-4">
                <div className="flex items-start group">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">Plant dragon fruit cuttings</p>
                ...
                <div className="flex items-start group">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">Install drip irrigation</p>
                ...
                <div className="flex items-start group">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">Apply organic fertilizer</p>
