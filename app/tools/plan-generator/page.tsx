      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Create a customized agricultural business plan tailored to your specific crops, location, and resources.
          </p>

          <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-8">
            <h3 className="text-lg font-semibold text-blue-900 mb-2">📝 Interactive Planning Tool</h3>
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">High-level overview of your agricultural operation and business goals</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">Detailed specifications for infrastructure, irrigation, and crop management</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">Comprehensive financial analysis including investment, costs, and revenue forecasts</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">Daily operations procedures, maintenance schedules, and best practices</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">Marketing plan, pricing strategy, and sales channels</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">Identification and mitigation strategies for potential risks</p>
              </div>
            </div>
          </div>
        </div>
