  ...
  const templates: CropTemplate[] = [
    {
      ...
      category: 'Fruits',
      icon: '🐉',
      description: 'High-value exotic fruit with wall-farming potential. Low water requirements, ideal for semi-arid climates.',
    ...
    },
    {
      ...
      icon: '🌿',
      description: 'Fast-growing superfood tree. Leaves harvested for powder production. Drought-tolerant and nutritious.',
    ...
    },
    {
      ...
      icon: '🌾',
      description: 'High-protein fodder crop. Multiple harvests per year. Excellent for livestock feed production.',
    ...
    },
    {
      ...
      category: 'Vegetables',
      icon: '🍅',
      description: 'Popular vegetable crop with high market demand. Requires consistent care and pest management.',
    ...
    },
    {
      ...
      category: 'Vegetables',
      icon: '🫑',
      description: 'High-value vegetable with good storage life. Multiple harvests from same plants.',
    ...
    },
    {
      ...
      category: 'Herbs',
      icon: '🌱',
      description: 'Popular culinary herb with high demand. Quick growing and profitable in small spaces.',
    ...
    },
    {
      ...
      category: 'Fruits',
      icon: '🍓',
      description: 'High-value berry crop. Suitable for vertical farming and protected cultivation.',
    ...
    },
    {
      ...
      category: 'Vegetables',
      icon: '🥬',
      description: 'Hardy superfood vegetable. Cold-tolerant and nutritious. Growing market demand.',
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <p className="text-lg text-gray-600 mb-6">
            Explore pre-built templates for common agricultural crops. Each template includes detailed growing requirements, 
            financial projections, and best practices.
          </p>
